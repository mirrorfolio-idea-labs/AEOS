...
> **Generated view** — as of `dd107d9` + end-to-end roadmap extension, 2026-07-13,
> branch `feat/aeos-p1-m1-contracts`.
...
|---|---|---|---|---|
| M1 contracts | `[~]` | 5/6 | [plan](../superpowers/plans/2026-07-13-aeos-p1-m1-contracts.md) | T1–T5 on branch, 17/17 tests verified green |
