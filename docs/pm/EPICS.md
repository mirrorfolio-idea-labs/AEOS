...
|---|---|---|---|---|---|---|
| **P1 — Spine** | Prove the core loop: durable agents that survive daemon death and resume from checkpoints, all state as files. [Scope](../ROADMAP.md#phase-p1--spine-v01) | v0.1 | P0 | Kabeer | `[~]` (M1 in progress) | M1–M9 |
